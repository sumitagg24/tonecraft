...
| 0.2 | **Dodo webhook active** | `/api/billing/webhook` whitelisted in `src/proxy.ts` (Dodo Standard Webhooks verification is the auth). Subscriptions can now activate. |
