      ...
      <div className="max-w-3xl mx-auto px-4 py-24">
        ...
        >
          ...
          <div className="glass-panel rounded-2xl p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              All data is encrypted in transit using TLS and at rest using industry-standard encryption. API keys and sensitive credentials are encrypted and never exposed to clients.
            </p>
          </div>
